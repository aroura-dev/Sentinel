package com.aroura.sentinel.datahouse.constants;
...
public class DataHouseConstant {
     ...
     * 库名
     */
    public static final String CATALOG_DEFAULT_DATABASE = "sentinel";
    /**
     * 消费Kafka消息，写入的表
     */
     ...
     * 源Kafka topic
     */
    public static final String KAFKA_TOPIC = "sentinelTraceLog";
    /**
     * eg:  127.0.0.1:9092
     * 消费Kafka的ip和端口
     */
