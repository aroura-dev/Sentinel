package com.aroura.sentinel.cron.pending;
...
import com.aroura.sentinel.cron.config.CronAsyncThreadPoolConfig;
import com.aroura.sentinel.cron.constants.PendingConstant;
import com.aroura.sentinel.cron.vo.CrowdInfoVo;
import com.aroura.sentinel.service.api.domain.BatchSendRequest;
...
import com.aroura.sentinel.support.pending.AbstractLazyPending;
import com.aroura.sentinel.support.pending.PendingParam;
...
public class CrowdBatchTaskPending extends AbstractLazyPending<CrowdInfoVo> {
    ...
    public CrowdBatchTaskPending() {
        ...
        pendingParam.setQueue(new LinkedBlockingQueue<>(PendingConstant.QUEUE_SIZE))
                ...
                .setNumThreshold(SentinelConstant.BATCH_RECEIVER_SIZE)
