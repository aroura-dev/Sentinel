package com.aroura.sentinel.support.mq.rabbit;
...
public class RabbitSendMqServiceImpl implements SendMqService {
    ...
    @Value("${sentinel.rabbitmq.exchange.name}")
    ...
    @Value("${sentinel.rabbitmq.routing.send}")
    private String sendRoutingKey;

    @Value("${sentinel.rabbitmq.routing.recall}")
    ...
    public void send(String topic, String jsonValue, String tagId) {
        ...
        }else if (topic.equals(sentinelRecall)){
