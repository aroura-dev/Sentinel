 ...
 */
@Slf4j
public class SentinelFileUtils {

    private SentinelFileUtils() {
    ...
    public static File getRemoteUrl2File(String path, String remoteUrl) {
        ...
        try {
            ...
            if (!CommonConstant.HTTP.equalsIgnoreCase(protocol)
                ...
                log.error("SentinelFileUtils#getRemoteUrl2File fail:{}, remoteUrl:{}",
            ...
            if (!file.exists()) {
                ...
                if (!res) {
                    log.error("SentinelFileUtils#getRemoteUrl2File Failed to create folder, path:{}, remoteUrl:{}", path, remoteUrl);
                    return null;
                }
            ...
            log.error("SentinelFileUtils#getRemoteUrl2File fail:{},remoteUrl:{}", Throwables.getStackTraceAsString(e), remoteUrl);
        } finally {
