...
import com.aroura.sentinel.web.service.sentinel.WorkOrderEventHandler;
 ...
 * <p>
 * 仅在 sentinel.mq.pipeline=kafka 时启用；幂等与业务处理在 {@link WorkOrderEventHandler}。
 *
 * @author sentinel
 */
@Slf4j
@Component
@ConditionalOnProperty(name = "sentinel.mq.pipeline", havingValue = "kafka")
