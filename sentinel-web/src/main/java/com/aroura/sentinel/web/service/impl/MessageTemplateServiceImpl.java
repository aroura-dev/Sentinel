package com.aroura.sentinel.web.service.impl;
...
import com.aroura.sentinel.common.enums.AuditStatus;
import com.aroura.sentinel.common.enums.MessageStatus;
import com.aroura.sentinel.common.enums.RespStatusEnum;
import com.aroura.sentinel.common.enums.TemplateType;
import com.aroura.sentinel.common.vo.BasicResultVO;
import com.aroura.sentinel.cron.xxl.entity.XxlJobInfo;
import com.aroura.sentinel.cron.xxl.service.CronTaskService;
import com.aroura.sentinel.cron.xxl.utils.XxlJobUtils;
...
public class MessageTemplateServiceImpl implements MessageTemplateService {
    ...
    public Page<MessageTemplate> queryList(MessageTemplateParam param) {
        ...
        String creator = CharSequenceUtil.isBlank(param.getCreator()) ? SentinelConstant.DEFAULT_CREATOR : param.getCreator();
    ...
    private void initStatus(MessageTemplate messageTemplate) {
        messageTemplate.setFlowId(CharSequenceUtil.EMPTY)
                ...
                .setCreator(CharSequenceUtil.isBlank(messageTemplate.getCreator()) ? SentinelConstant.DEFAULT_CREATOR : messageTemplate.getCreator())
                .setUpdator(CharSequenceUtil.isBlank(messageTemplate.getUpdator()) ? SentinelConstant.DEFAULT_UPDATOR : messageTemplate.getUpdator())
                .setTeam(CharSequenceUtil.isBlank(messageTemplate.getTeam()) ? SentinelConstant.DEFAULT_TEAM : messageTemplate.getTeam())
                .setAuditor(CharSequenceUtil.isBlank(messageTemplate.getAuditor()) ? SentinelConstant.DEFAULT_AUDITOR : messageTemplate.getAuditor())
