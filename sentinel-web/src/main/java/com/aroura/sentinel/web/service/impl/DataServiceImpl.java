...
import com.aroura.sentinel.common.domain.SimpleAnchorInfo;
import com.aroura.sentinel.common.enums.AnchorState;
import com.aroura.sentinel.common.enums.ChannelType;
import com.aroura.sentinel.common.enums.EnumUtil;
import com.aroura.sentinel.service.api.domain.TraceResponse;
import com.aroura.sentinel.service.api.service.TraceService;
...
import com.aroura.sentinel.support.utils.RedisUtils;
import com.aroura.sentinel.support.utils.TaskInfoUtils;
import com.aroura.sentinel.web.service.DataService;
import com.aroura.sentinel.web.utils.AnchorStateUtils;
import com.aroura.sentinel.web.utils.Convert4Amis;
import com.aroura.sentinel.web.vo.DataParam;
import com.aroura.sentinel.web.vo.amis.EchartsVo;
import com.aroura.sentinel.web.vo.amis.SmsTimeLineVo;
import com.aroura.sentinel.web.vo.amis.UserTimeLineVo;
...
public class DataServiceImpl implements DataService {
    ...
    private String getRealBusinessId(String businessId) {
        if (SentinelConstant.BUSINESS_ID_LENGTH == businessId.length()) {
            return businessId;
        }
