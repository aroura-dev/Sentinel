package com.aroura.sentinel.web.aspect;

import cn.hutool.core.util.IdUtil;
import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.google.common.collect.Lists;
import com.aroura.sentinel.web.vo.RequestLogDTO;
...
public class SentinelAspect {
     ...
     * 只切SentinelAspect注解
     */
    @Pointcut("@within(com.aroura.sentinel.web.annotation.SentinelAspect) || @annotation(com.aroura.sentinel.web.annotation.SentinelAspect)")
