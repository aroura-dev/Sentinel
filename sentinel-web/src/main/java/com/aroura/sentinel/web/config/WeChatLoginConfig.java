...
import com.aroura.sentinel.common.constant.OfficialAccountParamConstant;
import com.aroura.sentinel.common.dto.account.WeChatOfficialAccount;
...
@ConditionalOnProperty(name = "sentinel.login.official.account.enable", havingValue = "true")
@Data
public class WeChatLoginConfig {

    @Value("${sentinel.login.official.account.appId}")
    private String appId;
    @Value("${sentinel.login.official.account.secret}")
    private String secret;
    @Value("${sentinel.login.official.account.token}")
