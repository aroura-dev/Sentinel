package com.aroura.sentinel.web.advice;
 ...
 * @date 2023/2/9 19:00
 */
@ControllerAdvice(basePackages = "com.aroura.sentinel.web.controller")
public class SentinelResponseBodyAdvice implements ResponseBodyAdvice<Object> {

    private static final String RETURN_CLASS = "BasicResultVO";

    @Override
    public boolean supports(MethodParameter methodParameter, Class aClass) {
        return methodParameter.getContainingClass().isAnnotationPresent(SentinelResult.class) || methodParameter.hasMethodAnnotation(SentinelResult.class);
    }
