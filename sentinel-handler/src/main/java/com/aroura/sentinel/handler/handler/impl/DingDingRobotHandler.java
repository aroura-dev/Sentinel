...
import com.aroura.sentinel.common.dto.account.DingDingRobotAccount;
import com.aroura.sentinel.common.dto.model.DingDingRobotContentModel;
import com.aroura.sentinel.common.enums.ChannelType;
import com.aroura.sentinel.common.enums.SendMessageType;
import com.aroura.sentinel.handler.domain.dingding.DingDingRobotParam;
import com.aroura.sentinel.handler.domain.dingding.DingDingRobotResult;
...
public class DingDingRobotHandler extends BaseHandler{
    ...
    public boolean handler(TaskInfo taskInfo) {
        try {
            ...
            // 常见的错误 应当 关联至 AnchorState,由sentinel后台统一透出失败原因
    ...
    private DingDingRobotParam assembleParam(TaskInfo taskInfo) {
        ...
        if (SentinelConstant.SEND_ALL.equals(CollUtil.getFirst(taskInfo.getReceiver()))) {
