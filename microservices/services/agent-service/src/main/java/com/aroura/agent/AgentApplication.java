...
@ComponentScan(basePackages = {"com.aroura.sentinel.agent", "com.aroura.agent"}, excludeFilters = {
        ...
        @ComponentScan.Filter(type = FilterType.REGEX, pattern =
                "com\\.aroura\\.sentinel\\.agent\\.tool\\.(LogisticsQuery|ChannelQuote|EtaPredict|Workorder|AnomalyKnowledge)Tool"),
        @ComponentScan.Filter(type = FilterType.REGEX, pattern =
                "com\\.aroura\\.sentinel\\.agent\\.config\\.LangChain4jConfig")
})
