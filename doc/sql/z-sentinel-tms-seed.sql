...
('赵敏', '$2a$10$6kLzPvqf.Ev8jVD.HpYW8ejTSA3Rp3eECIracYmJH8uK1eORQH46K', '赵敏', 'FINANCE', 1)
...
(1, 'MCH-0001', '深圳蓝鲸科技', (SELECT id FROM `sentinel_user` WHERE `username` = '陈浩' LIMIT 1), '王海', '13800138001', 'wh@lanjing.cn', 'CN', 1),
...
(1, 'BILL-AIRGO-202608', 2, '2026-08-01', '2026-08-31', 'CNY', 341.90, 'SUBMITTED', '赵敏', DATE_SUB(NOW(), INTERVAL 2 DAY), NULL, NULL, NULL, NULL),
(2, 'BILL-CARGOWAY-202608', 1, '2026-08-01', '2026-08-31', 'CNY', 195.00, 'DRAFT', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'BILL-SEAGO-202607', 3, '2026-07-01', '2026-07-31', 'CNY', 54.00, 'SETTLED', '赵敏', DATE_SUB(NOW(), INTERVAL 20 DAY), '赵敏', DATE_SUB(NOW(), INTERVAL 18 DAY), '赵敏', DATE_SUB(NOW(), INTERVAL 15 DAY))
